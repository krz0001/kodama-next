    ...
    <footer className="border-t border-slate-500/20 mt-10">
      <div className="container max-w-4xl mx-auto flex py-8 flex-col text-center">
        <div className="w-full mx-auto flex justify-center flex-wrap items-center gap-3">
          <Link href="https://kodamasoft.booth.pm/" className="footer_svg_container outline-none">
            <BoothSVG className='text-slate-500 no-underline hover:text-slate-50 hover:scale-105 w-12 h-12 transition' />
          </Link>
          <Link href="https://soundcloud.com/kodamasoft" className="footer_svg_container outline-none">
            <FaSoundcloud className='text-slate-500 no-underline hover:text-slate-50 hover:scale-105 w-12 h-12 transition' />
          </Link>
          <Link href="https://www.youtube.com/@kodamasoft" className="footer_svg_container outline-none">
            <FaYoutube className='text-slate-500 no-underline hover:text-slate-50 hover:scale-105 w-12 h-12 transition' />
          </Link>
