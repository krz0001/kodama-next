...
- Similarly to physical goods, you must agree with us publishing our “ECLECTIC RESONANCE” original work albums on major streaming platforms (Spotify, Apple Music, Deezer…) a year after they have initially released on Bandcamp/BOOTH. At the moment of streaming distribution, we will ensure that your track’s metadata will be appropriately linked to the correct artist page. Such matters can be discussed with us at any time so we can adapt in the best possible ways. Just like for physical goods, streaming distribution revenues will not warrant meaningful profits and is considered a bonus.
</WrappableParagraph>
